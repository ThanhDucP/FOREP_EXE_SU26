    ...
    SecurityFilterChain securityFilterChain(HttpSecurity http, JwtAuthenticationFilter jwtAuthenticationFilter) throws Exception {
        return http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers("/api/v1/analytics/**", "/api/v1/ai/**", "/api/workspace/ai/**", "/api/workspace/ai-history", "/api/workspace/workload/**", "/api/workspace/business-owner/**").hasAnyRole("BUSINESS_OWNER", "EXECUTIVE", "MANAGER", "HR", "OWNER")
                        .requestMatchers("/api/workspace/tasks/**").hasAnyRole("BUSINESS_OWNER", "EXECUTIVE", "MANAGER", "EMPLOYEE", "OWNER")
                        .requestMatchers("/api/v1/workspaces/current").hasAnyRole("BUSINESS_OWNER", "OWNER", "HR", "EXECUTIVE", "MANAGER", "EMPLOYEE")
